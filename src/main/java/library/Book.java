...
public class Book extends BookTitle {
	 ...
	 * class Book constructor.
	 * 
	 * @param inBookId     int book's identification number.
	 ...
	 *
	 */
	public Book(int inBookId, Member inBorrower, Librarian inLibrarian, String inDueDate, String inCallNumber,
			String inName, String inAuthors, String inIsbn, String inEdition, String inPublisher, int inYear) {
	 ...
	 * @return void
	 */
	public void setBookID(int inBookId) {
		bookId = inBookId;
	}
