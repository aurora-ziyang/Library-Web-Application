...
/**
 * This bean represents a member. Class <code>Member</code> inherits from class
 * <code>LibraryUser</code>.
 *
 * @author A Jiayi
 * @version 1.0
 */
public class Member extends LibraryUser {
	 ...
	 */
	public Member(int inSsn, String inFamilyName, String inGivenName, String inStreet, String inCity, String inState,
			String inPostalCode, String inPhoneNumber, String inEmail, String inPasswd, String inDLicState,
			String inDLicNum) {
