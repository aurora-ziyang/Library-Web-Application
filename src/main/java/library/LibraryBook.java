...
/**
 * Class LibraryBook is a heavy weight representation of a book at a library
 * 
 * @author A Jiayi
 * @version 1.0
 */
public class LibraryBook {
	 ...
	 * @return Book
	 */
	public static Book getBook(int inBookId) throws Exception {

		Book myBook = null;
		String sqlQuery = "select * from book b, booktitle bt where b.callnumber = bt.callnumber and b.bookid="
				+ inBookId;
		...
		if (r.next()) {
			...
			myBook = new Book(r.getInt("bookid"), LibraryMember.getMember(r.getInt("borrowerssn")),
					LibraryLibrarian.getLibrarian(r.getInt("librarianssn")), r.getString("duedate"),
					r.getString("callnumber"), r.getString("name"), r.getString("author"), r.getString("isbn"),
					r.getString("edition"), r.getString("publisher"), r.getInt("publishedYear"));
		}
	 ...
	 * @return boolean
	 */
	public static boolean isCheckedOut(int inBookId) throws Exception {
