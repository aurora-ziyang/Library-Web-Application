...
/**
 * This bean represents an abstraction of the two types of users of the library
 * web application, namely Librarians and Members. Class <code>Librarian</code>
 * and class <code>Member</code> inherit from the <code>LibraryUser</code>
 * class.
 *
 * @author A Jiayi
 * @version 1.0
...
public class LibraryUser {
	 ...
	 * 
	 * @param inSsn         int library user's ssn.
	 ...
	 */
	public LibraryUser(int inSsn, String inFamilyName, String inGivenName, String inStreet, String inCity,
			String inState, String inPostalCode, String inPhoneNumber, String inEmail, String inPasswd) {
		ssn = inSsn;
	 ...
	 * 
	 * @return String user's postal code
	 */
	 ...
	 * 
	 * @return String first and last name, separated by a single space
	 */
