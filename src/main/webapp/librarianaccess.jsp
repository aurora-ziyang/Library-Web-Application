...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/libraryWithMySQL/styles.css">
  </head>
  ...
  <body>
    ...
    <div style="margin-left: 2em">
      ...
      <form action="/libraryWithMySQL/LibrarianCheckoutController" method="post">
	...
	<!-- Display a form that allows a librarian to send books to the
      ...
      <form action="/libraryWithMySQL/LibrarianCheckinController" method="post">
